...
const _$ComplexityEnumMap = {
  Complexity.proste: 'proste',
  Complexity.wymagajace: 'wymagajace',
  Complexity.trudne: 'trudne',
};

const _$AffordabilityEnumMap = {
  Affordability.tanie: 'tanie',
  Affordability.kosztowne: 'kosztowne',
  Affordability.drogie: 'drogie',
};
